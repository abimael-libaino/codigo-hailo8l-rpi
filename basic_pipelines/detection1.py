...
def app_callback(pad, info, user_data):
    ...
    detection_count = 0
    person_detected = False  # Flag to check if a person was detected
    ...
    if user_data.use_frame:
        ...
        if person_detected:  # Save the frame if a person is detected
            image_dir = "imagens"
            ...
            cv2.imwrite(image_path, frame)  # Save the frame as a JPG image
